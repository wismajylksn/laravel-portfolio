...
@section('content')
     ...
     alt="Profile Picture">
                ...
                <div class="col-lg-7 text-center text-lg-left">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                       <a href="{{ asset('storage/' . $setting->cv_url) }}" class="btn btn-outline-light mr-5" target="_blank">
                     Download CV
                        </a>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-primary text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="container text-center py-5">
            ...
            <p class="m-0">&copy; <a class="text-white font-weight-bold" href="#">WismaFolio</a>. All Rights Reserved. Designed by<a class="text-white font-weight-bold" href="https://htmlcodex.com"> Wisma Jaya Laksana</a>
            </p>
        </div>
    </div>
    <!-- Footer End -->
