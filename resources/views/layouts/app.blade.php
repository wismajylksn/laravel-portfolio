...
<head>
    ...
    <!-- Favicon -->
   <link rel="icon" href="{{ asset('import/assets/img/favicon-32.png') }}" type="image/png">
<link rel="shortcut icon" href="{{ asset('import/assets/img/favicon-32.png') }}">
...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
    ...
    <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        <a href="index.html" class="navbar-brand ml-lg-3">
            <h1 class="m-0 display-5"><span class="text-primary">Wisma</span>Folio</h1>
        </a>
